...
fun Project.setupApp() {
    // Allow CI to override package name via env var (e.g. top.nb4a.m3e for Compose variant)
    val pkgName = System.getenv("PACKAGE_NAME") ?: requireMetadata().getProperty("PACKAGE_NAME")
